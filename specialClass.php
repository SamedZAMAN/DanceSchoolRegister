...
<body id="page-top">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <div class="bilgiler">
                        <h1 class="h2 mb-2 text-primary">Özel Ders Kayıtlı Tablosu</h1>
                        <!-- ÖDEMEYİ SIFIRLA -->
                    </div>
                    ...
                    <!-- Tablo -->
                    <form action="class-process.php" method='post' class="mt-1">
                        ...
                        <caption>
                            ...
                            <tr>
                                ...
                                <th scope="col" class="hidden">Telefon</th>
                                <th scope="col" class="">Kayıt Tarihi</th>
                                <th scope="col">Not</th>
                                ...
                                while($row = $result->fetch_assoc()){
                                    ...
                                    echo "
                                        <tr>
                                            ...
                                            <td class='$row[tname]' id='tname_id$row[id]'><span id='tname_$row[id]'>$row[tname]</span></td>
                                            ...
                                            <td class='$row[note]' id='note_id$row[id]'><span id='note_$row[id]'>$row[note]</span></td>
                                            <td id='edit_id$row[id]' class='edit_buttons'>
                                                <a class='btn btn-primary btn-sm edit-btn' id='edit-$row[id]' onClick='tiklaSpecial($row[id])'>Edit</a>
                                            ...
                                            <td id='edit_id$row[id]' class='hidden_buttons d-none'>
                                                ...
                                                <button class='btn btn-danger btn-sm delete-btn' id='delete-$row[id]' value='$row[id]' name ='deleteSpecialUser' type='submit'>Delete</button>
                                            </td>
                                        </tr>
                                    ";
                                    $i +=1;
    ...
    <script>
        ...
        function checkDelete(button){
            ...
            // EDİT VE DELETE BUTONU AKTİVİTELERİ
        function tiklaSpecial(touched_id){
            const edit_btn = document.querySelector("#edit-"+touched_id);
            const delete_btn = document.querySelector("#delete-"+touched_id);
            const note_dom = document.querySelector("#note_"+touched_id);
            //butonu değiştirme
            ...
            note_dom.style.display = "none";

            //note textini açma
            const note_bilgi = note_dom.innerText;
            const note_edit = document.createElement("textarea");
            note_edit.name = "note";
            note_edit.rows = "3";
            note_edit.cols = "20";
            note_edit.value = note_bilgi;
            

            document.getElementById("note_id"+touched_id).appendChild(note_edit);

            //edit button
            const text_edit = document.createElement("button");
            text_edit.className = "btn btn-warning btn-sm edit-btn";
            text_edit.type ="submit";
            text_edit.name = "editSpecialUser";
            text_edit.value = touched_id;
            text_edit.innerHTML = "Kaydet";

            document.getElementById("edit_id"+touched_id).appendChild(text_edit);
            ...
            document.getElementById("edit_id"+touched_id).appendChild(iptal_edit);
        ...
        note_dom.style.display = "inline-block";
