            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="search">
                        ...
                        <button id="filt" type="button" class="btn btn-warning"> Filtreler <i class='bx bx-menu'></i></button> 
                        </div>
                        <div class="box">
                    ...
                    <div id="filtreler">
                        ...
                        <li><span class="underln">Dans Türü</span>
                            <ol>
                            <li>Salsa <input type="checkbox"></li>
                            <li>Bachata <input type="checkbox"></li>
                            <li>Tango <input type="checkbox"></li>
                            <li>Kizomba <input type="checkbox"></li>
                            </ol>
                        </li>
                        <li><span class="underln">Cisiyet</span> 
                            <ol>
                            <li>Kadın <input type="radio" name="sex"></li>
                            <li>Erkek <input type="radio" name="sex"></li>
                            </ol>
                        </li>
                        ...
                        <caption>
                            ...
                            <?php 
                                ...
                                while($row = $result->fetch_assoc()){
                                    ...
                                    if (htmlspecialchars($formatted_date ?? date('Y-m-d')) > $row['ldate']){
                                    echo "
                                    <tr>
